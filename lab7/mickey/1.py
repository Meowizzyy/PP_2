...
sec = pg.image.load(r"C:\Users\ruste\Desktop\cxc\lab7\mickey\leftarm.png").convert_alpha()
minute = pg.image.load(r"C:\Users\ruste\Desktop\cxc\lab7\mickey\rightarm.png").convert_alpha()
rectsec = sec.get_rect()
rectmin = minute.get_rect()
rectmin.center = rectsec.center = midle

background = pg.image.load(r"C:\Users\ruste\Desktop\cxc\lab7\mickey\mainclock.png")
run =True
